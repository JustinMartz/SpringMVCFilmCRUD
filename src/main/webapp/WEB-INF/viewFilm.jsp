...
<c:choose>
    <c:when test="${not empty list}">
        ...
        <h1>DEBUG</h1>
            ...
            <span>Rented rate: </span><fmt:formatNumber value="${film.rentalRate}" type="currency" /> per day<br>
            <span>Running time: </span>${film.length} minutes<br>
            <span>Replacement cost: </span><fmt:formatNumber value="${film.replacementCost}" type="currency" /><br>
    ...
    <c:when test="${not empty film}">
        ...
        <form action="editFilm.do" method="POST">
            ...
            Enter Rental Duration: <input type="text" id="rentalDuration" name="rentalDuration" size="15" value="${film.rentalDuration}"><br>
            Enter Rental Rate: <input type="text" id="rentalRate" name="rentalRate" size="10" value="${film.rentalRate}"><br>
            Enter Running Time: <input type="text" id="length" name="length" size="10" value="${film.length}"><br>
            Enter Replacement Cost: <input type="text" id="replacementCost" name="replacementCost" size="10" value="${film.replacementCost}"><br>
            Enter Rating: <input type="text" id="rating" name="rating" size="10" value="${film.rating}"><br>
